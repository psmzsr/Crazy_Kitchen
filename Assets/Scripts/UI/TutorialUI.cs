...
public class TutorialUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI keyGamepadGamepadPauseText;
    ...
    private void UpdateVisual()
    {
        ...
        keyGamepadGamepadPauseText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Gamepad_Pause);
    }
